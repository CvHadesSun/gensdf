...
from model.diffusion import inference
...
def main():
    ...
    ddpm_args = Namespace(
        ...
        explicit_normalization=False, save_dir=args.save_dir, save_intermediate=False, save_timestep_interval=20, image_size=args.resolution, num_channels=256, 
        ...
        diffusion_steps=1000, noise_schedule='linear', timestep_respacing="", use_kl=False, predict_xstart=False, rescale_timesteps=False, 
        rescale_learned_sigmas=False,local_rank=args.local_rank
    )
    samples = inference.main(args=ddpm_args)  # Run ddpm
